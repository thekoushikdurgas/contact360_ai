                        ...
                        <div className="flex gap-3">
                           ...
                           <div>
                              ...
                              <div className="flex gap-2 mt-1">
                                {company.website && (
                                  <a href={company.website} target="_blank" rel="noreferrer" onClick={(e) => e.stopPropagation()} className="text-xs text-slate-500 hover:text-indigo-500 flex items-center gap-1 transition-colors">
                                    <Globe size={10} /> Website
                                  </a>
                                )}
                                {company.linkedin_url && (
                                  <a href={company.linkedin_url} target="_blank" rel="noreferrer" onClick={(e) => e.stopPropagation()} className="text-xs text-slate-500 hover:text-[#0077b5] flex items-center gap-1 transition-colors">
                         ...
                         <td className="p-4">
                           <div className="flex items-center gap-3">
                             ...
                             <div>
                               ...
                               <a href={company.website || '#'} target="_blank" onClick={(e) => e.stopPropagation()} className="text-xs text-slate-500 hover:text-indigo-500">{company.website}</a>
                             </div>
                           </div>
                         </td>
